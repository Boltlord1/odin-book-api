...
const validateInitial: RequestHandler = (req, res, next) => {
	req.errors = []
	next()
}
...
const validateAvatar: RequestHandler = async (req, res, next) => {
	const errors = req.errors
...
const validateImages: RequestHandler = async (req, res, next) => {
	const errors = req.errors
...
const validateFinal: RequestHandler = async (req, res, next) => {
	const errors = req.errors
	if (errors.length > 0) {
